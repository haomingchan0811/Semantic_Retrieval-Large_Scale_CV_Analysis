...
#     stop = list(SW)
    ...
    BOW_X = np.zeros((num_lines,), dtype=np.object)     # BOW(word frequency) vectors matrix, iTH column is the iTH document's BOW matrix
...
#                     continue
        ...
        BOW_X[count] = bow_xs                                     # store the BOW vectors of the countTH document
        count = count + 1
